...
var app = (function () {
    ...
    const file$c = "node_modules\\svelte-particles\\src\\Particles.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$c, 53, 0, 1254);
    		},
    ...
    class Particles extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { options: 1, url: 2, id: 0 });
    ...
    var wsStore = writable$1(new WebSocket('ws://localhost:9000/ws'));

    var toast = writable$1(undefined);
    ...
    const store = writable$1(undefined);
        ...
        switch (message.event) {
          case "login_user":
            if(message.token == "false") {
              toast.set("mot de passe incorrect");
            } else if(message.token == "failure") {
              toast.set("utilisateur inexistant!");
            } else {
          ...
          case "create_user":
            if(message.token == "failure") {
              toast.set("erreur lors de la création de l'utilisateur");
            } else {
              userStore.set({id: message.id, pseudo: message.username, token: message.token});
            }
            break;
    ...
    function createRoom(name) {
      ...
      if (socket.readyState)
        socket.send(JSON.stringify({ event: "create_room", user_id: get_store_value(userStore).id, name:name}));
    }

    function joinRoom(name) {
      console.debug("join_room", socket.readyState);
      if (socket.readyState) {
        socket.send(JSON.stringify({ event: "join_room", user_id: get_store_value(userStore).id, name: name }));
      } else socket.onopen = () => {
        console.log(roomId);
        socket.send(JSON.stringify({ event: "join_room", name:name, user_id:get_store_value(userStore).id }));
      };
    }
    ...
    function newCard() {
      ...
      if (socket.readyState)
        socket.send(JSON.stringify({ event: "new_card", name:roomId, user_id: get_store_value(userStore).id }));
    }
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h2, file$b, 86, 4, 2021);
    			attr_dev(label0, "for", "userName");
    			attr_dev(label0, "class", "svelte-jggw3");
    			add_location(label0, file$b, 88, 12, 2081);
    			...
    			add_location(input0, file$b, 89, 12, 2133);
    			attr_dev(div0, "class", "inputBox svelte-jggw3");
    			add_location(div0, file$b, 87, 8, 2045);
    			attr_dev(label1, "for", "userPassword");
    			attr_dev(label1, "class", "svelte-jggw3");
    			add_location(label1, file$b, 92, 12, 2314);
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*valueUsername*/ ctx[0]);
    			...
    			set_input_value(input1, /*valuePassword*/ ctx[1]);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(room.login(/*valueUsername*/ ctx[0], /*valuePassword*/ ctx[1]))) room.login(/*valueUsername*/ ctx[0], /*valuePassword*/ ctx[1]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*valueUsername*/ 1 && input0.value !== /*valueUsername*/ ctx[0]) {
    				set_input_value(input0, /*valueUsername*/ ctx[0]);
    			}

    			if (dirty & /*valuePassword*/ 2 && input1.value !== /*valuePassword*/ ctx[1]) {
    				set_input_value(input1, /*valuePassword*/ ctx[1]);
    			}
    		},
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	function input0_input_handler() {
    		valueUsername = this.value;
    		$$invalidate(0, valueUsername);
    	}

    	function input1_input_handler() {
    		valuePassword = this.value;
    		$$invalidate(1, valuePassword);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('valueUsername' in $$props) $$invalidate(0, valueUsername = $$props.valueUsername);
    		if ('valuePassword' in $$props) $$invalidate(1, valuePassword = $$props.valuePassword);
    	};
    	...
    	return [valueUsername, valuePassword, input0_input_handler, input1_input_handler];
    }
    ...
    function create_if_block$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text("Les mots de passes ne correspondent pas!");
    			this.h();
    		},
    		l: function claim(nodes) {
    			p = claim_element(nodes, "P", { class: true });
    			var p_nodes = children(p);
    			t = claim_text(p_nodes, "Les mots de passes ne correspondent pas!");
    			p_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			attr_dev(p, "class", "failure svelte-5gy44k");
    			add_location(p, file$a, 123, 12, 3435);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$c(ctx) {
    	...
    	let if_block = /*failure*/ ctx[3] && create_if_block$a(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			a = claim_element(main_nodes, "A", { class: true, href: true, style: true });
    			var a_nodes = children(a);
    		...
    		h: function hydrate() {
    			attr_dev(h2, "class", "svelte-5gy44k");
    			add_location(h2, file$a, 104, 4, 2445);
    			attr_dev(label0, "for", "userName");
    			attr_dev(label0, "class", "svelte-5gy44k");
    			add_location(label0, file$a, 106, 12, 2508);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "userName");
    			attr_dev(input0, "id", "userName");
    			attr_dev(input0, "placeholder", "type your username");
    			input0.required = true;
    			attr_dev(input0, "class", "svelte-5gy44k");
    			add_location(input0, file$a, 107, 12, 2560);
    			attr_dev(div0, "class", "inputBox svelte-5gy44k");
    			add_location(div0, file$a, 105, 8, 2472);
    			attr_dev(label1, "for", "userPassword");
    			attr_dev(label1, "class", "svelte-5gy44k");
    			add_location(label1, file$a, 110, 12, 2741);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "userPassword");
    			attr_dev(input1, "id", "userPassword");
    			attr_dev(input1, "placeholder", "type your password");
    			input1.required = true;
    			attr_dev(input1, "class", "svelte-5gy44k");
    			add_location(input1, file$a, 111, 12, 2797);
    			attr_dev(div1, "class", "inputBox svelte-5gy44k");
    			add_location(div1, file$a, 109, 8, 2705);
    			attr_dev(label2, "for", "userConfirmPassword");
    			attr_dev(label2, "class", "svelte-5gy44k");
    			add_location(label2, file$a, 116, 12, 3030);
    			...
    			attr_dev(input2, "class", "svelte-5gy44k");
    			add_location(input2, file$a, 117, 12, 3101);
    			attr_dev(div2, "class", "inputBox svelte-5gy44k");
    			add_location(div2, file$a, 115, 8, 2994);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "name", "");
    			set_style(button, "float", "left");
    			attr_dev(button, "class", "svelte-5gy44k");
    			add_location(button, file$a, 121, 8, 3315);
    			attr_dev(a, "class", "button svelte-5gy44k");
    			attr_dev(a, "href", "/");
    			set_style(a, "float", "left");
    			add_location(a, file$a, 125, 8, 3523);
    			attr_dev(main, "class", "box svelte-5gy44k");
    			add_location(main, file$a, 103, 0, 2421);
    			attr_dev(footer, "class", "svelte-5gy44k");
    			add_location(footer, file$a, 127, 0, 3591);
    		},
    		m: function mount(target, anchor) {
    			mount_component(particles, target, anchor);
    			insert_hydration_dev(target, t0, anchor);
    			...
    			set_input_value(input2, /*valueConfirmPassword*/ ctx[2]);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*check*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*valueConfirmPassword*/ 4 && input2.value !== /*valueConfirmPassword*/ ctx[2]) {
    				set_input_value(input2, /*valueConfirmPassword*/ ctx[2]);
    			}
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	const check = () => {
    		if (valuePassword == valueConfirmPassword) {
    			...
    			$$invalidate(2, valueConfirmPassword = "");
    			$$invalidate(1, valuePassword = "");
    			$$invalidate(0, valueUsername = "");
    			$$invalidate(3, failure = true);
    		}
    	};
    	...
    	function input2_input_handler() {
    		valueConfirmPassword = this.value;
    		$$invalidate(2, valueConfirmPassword);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('valueUsername' in $$props) $$invalidate(0, valueUsername = $$props.valueUsername);
    		if ('valuePassword' in $$props) $$invalidate(1, valuePassword = $$props.valuePassword);
    		if ('valueConfirmPassword' in $$props) $$invalidate(2, valueConfirmPassword = $$props.valueConfirmPassword);
    ...
    function create_if_block$9(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(g0, file$9, 91, 6, 1560);
    			...
    			add_location(g1, file$9, 87, 4, 1445);
    			...
    			add_location(svg, file$9, 78, 2, 1273);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$9, 99, 10, 1820);
    			...
    			add_location(path1, file$9, 105, 10, 2087);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$9, 93, 10, 1626);
    		},
    		m: function mount(target, anchor) {
    ...
    /* src\components\Dialog.svelte generated by Svelte v3.44.2 */
    ...
    function create_if_block$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(input, "class", "svelte-1ye1t3w");
    			add_location(input, file$8, 43, 6, 815);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$a(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*hasForm*/ ctx[1] && create_if_block$8(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			var h2_nodes = children(h2);
    			t0 = claim_text(h2_nodes, /*message*/ ctx[0]);
    			h2_nodes.forEach(detach_dev);
    			...
    			t3 = claim_text(button0_nodes, "Cancel");
    			button0_nodes.forEach(detach_dev);
    			t4 = claim_space(div_nodes);
    			button1 = claim_element(div_nodes, "BUTTON", {});
    			var button1_nodes = children(button1);
    			t5 = claim_text(button1_nodes, "Okay");
    			button1_nodes.forEach(detach_dev);
    			div_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			attr_dev(h2, "class", "svelte-1ye1t3w");
    			add_location(h2, file$8, 40, 2, 768);
    			add_location(button0, file$8, 50, 6, 964);
    			add_location(button1, file$8, 53, 6, 1036);
    			attr_dev(div, "class", "buttons svelte-1ye1t3w");
    			add_location(div, file$8, 49, 2, 935);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['message', 'hasForm'];
    ...
    class Dialog extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { message: 0, hasForm: 1 });
    ...
    function create_if_block$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h2, file$7, 3, 4, 89);
    			attr_dev(header, "class", "svelte-mz432w");
    			add_location(header, file$7, 2, 2, 75);
    			attr_dev(span0, "class", "svelte-mz432w");
    			add_location(span0, file$7, 11, 6, 277);
    			attr_dev(button0, "class", "svelte-mz432w");
    			add_location(button0, file$7, 9, 4, 203);
    			attr_dev(span1, "class", "svelte-mz432w");
    			add_location(span1, file$7, 15, 6, 382);
    			attr_dev(button1, "class", "svelte-mz432w");
    			add_location(button1, file$7, 13, 4, 323);
    			attr_dev(span2, "class", "svelte-mz432w");
    			add_location(span2, file$7, 19, 6, 508);
    			attr_dev(button2, "class", "svelte-mz432w");
    			add_location(button2, file$7, 17, 4, 429);
    			attr_dev(div0, "class", "container svelte-mz432w");
    			add_location(div0, file$7, 8, 2, 174);
    			attr_dev(div1, "class", "sidebar svelte-mz432w");
    			add_location(div1, file$7, 1, 0, 12);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button2, "click", /*showDialog*/ ctx[1], false, false, false)
    				];
    ...
    const file$6 = "src\\components\\TextSpace.svelte";
    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(p, file$6, 38, 6, 939);
    			add_location(div, file$6, 37, 4, 891);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(input, file$6, 31, 4, 737);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, input, anchor);
    ...
    function create_fragment$8(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*focus*/ ctx[2]) return create_if_block$6;
    ...
    const file$5 = "src\\components\\Postit.svelte";
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(span, file$5, 59, 6, 1270);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*hover*/ ctx[3] && create_if_block$5(ctx);
    	...
    	binding_callbacks.push(() => bind$1(textspace, 'value', textspace_value_binding));
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$5, 48, 2, 1030);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    class Postit extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { text: 0, id: 1, card: 2 });
    ...
    const file$4 = "src\\routes\\Board.svelte";
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(p, file$4, 146, 14, 3490);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, p, anchor);
    			append_hydration_dev(p, t);
    ...
    function create_if_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(142:12) {#if $room.cards.length > 0}",
    		ctx
    	});
    ...
    // (143:14) {#each $room.cards as card}
    function create_each_block(ctx) {
    	...
    	function postit_text_binding(value) {
    		/*postit_text_binding*/ ctx[6](value, /*card*/ ctx[10]);
    	}

    	function postit_id_binding(value) {
    		/*postit_id_binding*/ ctx[7](value, /*card*/ ctx[10]);
    	}

    	function postit_card_binding(value) {
    		/*postit_card_binding*/ ctx[8](value, /*card*/ ctx[10], /*each_value*/ ctx[11], /*card_index*/ ctx[12]);
    	}

    	let postit_props = {};

    	if (/*card*/ ctx[10].body !== void 0) {
    		postit_props.text = /*card*/ ctx[10].body;
    	}

    	if (/*card*/ ctx[10].id !== void 0) {
    		postit_props.id = /*card*/ ctx[10].id;
    	}

    	if (/*card*/ ctx[10] !== void 0) {
    		postit_props.card = /*card*/ ctx[10];
    	}

    	postit = new Postit({ props: postit_props, $$inline: true });
    	binding_callbacks.push(() => bind$1(postit, 'text', postit_text_binding));
    	binding_callbacks.push(() => bind$1(postit, 'id', postit_id_binding));
    	binding_callbacks.push(() => bind$1(postit, 'card', postit_card_binding));
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(143:14) {#each $room.cards as card}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	function sidebar_show_binding(value) {
    		/*sidebar_show_binding*/ ctx[9](value);
    	}
    	...
    	binding_callbacks.push(() => bind$1(sidebar, 'show', sidebar_show_binding));
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			var main_nodes = children(main);
    			div4 = claim_element(main_nodes, "DIV", { id: true, class: true });
    			...
    			var span0_nodes = children(span0);
    			t3 = claim_text(span0_nodes, "Actions");
    			span0_nodes.forEach(detach_dev);
    			div0_nodes.forEach(detach_dev);
    			t4 = claim_space(nav_nodes);
    			div1 = claim_element(nav_nodes, "DIV", { class: true });
    			var div1_nodes = children(div1);
    			claim_component(fa2.$$.fragment, div1_nodes);
    			t5 = claim_space(div1_nodes);
    			span1 = claim_element(div1_nodes, "SPAN", { class: true });
    			var span1_nodes = children(span1);
    			t6 = claim_text(span1_nodes, "Logout");
    			span1_nodes.forEach(detach_dev);
    			div1_nodes.forEach(detach_dev);
    			...
    			claim_component(sidebar.$$.fragment, div3_nodes);
    		...
    		h: function hydrate() {
    			add_location(h1, file$4, 124, 12, 2642);
    			attr_dev(span0, "class", "svelte-ncl1pu");
    			add_location(span0, file$4, 131, 20, 2960);
    			attr_dev(div0, "class", "svelte-ncl1pu");
    			add_location(div0, file$4, 129, 16, 2836);
    			attr_dev(span1, "class", "svelte-ncl1pu");
    			add_location(span1, file$4, 135, 18, 3118);
    			attr_dev(div1, "class", "svelte-ncl1pu");
    			add_location(div1, file$4, 133, 16, 3022);
    			attr_dev(nav, "class", "svelte-ncl1pu");
    			add_location(nav, file$4, 128, 12, 2813);
    			attr_dev(header, "class", "svelte-ncl1pu");
    			add_location(header, file$4, 123, 8, 2620);
    			attr_dev(div2, "class", "grid svelte-ncl1pu");
    			add_location(div2, file$4, 140, 10, 3243);
    			attr_dev(div3, "class", "container svelte-ncl1pu");
    			add_location(div3, file$4, 139, 8, 3208);
    			attr_dev(div4, "id", "app-container");
    			attr_dev(div4, "class", "svelte-ncl1pu");
    			add_location(div4, file$4, 122, 4, 2586);
    			add_location(main, file$4, 121, 0, 2574);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, main, anchor);
    			append_hydration_dev(main, div4);
    			append_hydration_dev(div4, header);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div1, "click", /*logout*/ ctx[2], false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => navigate('/choice', { replace: true });
    	const click_handler_1 = () => $$invalidate(0, sidebar_show = !sidebar_show);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$3, 43, 6, 1026);
    			attr_dev(div1, "class", "toast svelte-173jzku");
    			add_location(div1, file$3, 39, 4, 907);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
    			append_hydration_dev(div1, div0);
    ...
    function create_fragment$3(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*$toast*/ ctx[0] && create_if_block$2(ctx);
    ...
    const file$2 = "src\\routes\\Choice.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h2, file$2, 135, 4, 3882);
    			attr_dev(button0, "class", "svelte-733qr1");
    			add_location(button0, file$2, 137, 12, 3951);
    			attr_dev(div0, "class", "inputBox svelte-733qr1");
    			add_location(div0, file$2, 136, 8, 3915);
    			attr_dev(button1, "class", "svelte-733qr1");
    			add_location(button1, file$2, 140, 12, 4096);
    			attr_dev(div1, "class", "inputBox svelte-733qr1");
    			add_location(div1, file$2, 139, 8, 4060);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, h2, anchor);
    			append_hydration_dev(h2, t0);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(button0, file$2, 126, 4, 3360);
    			attr_dev(label, "for", "userName");
    			attr_dev(label, "class", "svelte-733qr1");
    			add_location(label, file$2, 128, 12, 3521);
    			attr_dev(input, "type", "text");
    			...
    			add_location(input, file$2, 129, 12, 3580);
    			attr_dev(div0, "class", "inputBox svelte-733qr1");
    			add_location(div0, file$2, 127, 8, 3485);
    			attr_dev(button1, "type", "submit");
    			attr_dev(button1, "name", "");
    			set_style(button1, "float", "left");
    			attr_dev(button1, "class", "svelte-733qr1");
    			add_location(button1, file$2, 132, 12, 3753);
    			set_style(div1, "align-items", "center");
    			attr_dev(div1, "class", "svelte-733qr1");
    			add_location(div1, file$2, 131, 8, 3705);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(room.join(/*value*/ ctx[2]))) room.join(/*value*/ ctx[2]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(button0, "class", "back svelte-733qr1");
    			add_location(button0, file$2, 117, 4, 2816);
    			attr_dev(label, "for", "userName");
    			attr_dev(label, "class", "svelte-733qr1");
    			add_location(label, file$2, 119, 12, 2978);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "name", "name");
    			attr_dev(input, "id", "name");
    			attr_dev(input, "placeholder", "type room name");
    			input.required = true;
    			attr_dev(input, "class", "svelte-733qr1");
    			add_location(input, file$2, 120, 12, 3037);
    			attr_dev(div0, "class", "inputBox svelte-733qr1");
    			add_location(div0, file$2, 118, 8, 2942);
    			attr_dev(button1, "type", "submit");
    			attr_dev(button1, "name", "");
    			set_style(button1, "float", "left");
    			attr_dev(button1, "class", "svelte-733qr1");
    			add_location(button1, file$2, 123, 12, 3210);
    			set_style(div1, "align-items", "center");
    			attr_dev(div1, "class", "svelte-733qr1");
    			add_location(div1, file$2, 122, 8, 3162);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, button0, anchor);
    			mount_component(fa, button0, null);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(room.create(/*value*/ ctx[2]))) room.create(/*value*/ ctx[2]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(main, file$2, 115, 0, 2765);
    			attr_dev(footer, "class", "svelte-733qr1");
    			add_location(footer, file$2, 144, 0, 4207);
    		},
    		m: function mount(target, anchor) {
    			mount_component(particles, target, anchor);
    			insert_hydration_dev(target, t0, anchor);
    ...
    /* node_modules\svelte-simple-modal\src\Modal.svelte generated by Svelte v3.44.2 */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$1, 389, 8, 10023);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(button, file$1, 381, 12, 9827);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(27:8) <Route path=\\\"register\\\">",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file, 24, 4, 964);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_store(room, 'room');
    	component_subscribe($$self, room, $$value => $$invalidate(2, $room = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$userStore*/ 2) {
    			id != "choice" && id != "register" && id != "login" && id != "" && $userStore.token != ''
    			? room.join(id)
    			: '';
    		}

    		if ($$self.$$.dirty & /*$room, $userStore*/ 6) {
    			$room && $room.id
